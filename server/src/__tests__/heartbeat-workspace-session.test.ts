...
// SSO-17711: every configured project workspace path was unreachable, so resolveWorkspaceForRun
...
// SSO-17711: ensurePersistedExecutionWorkspaceAvailable's only non-worktree freshness check used
...
// SSO-17711: Paperclip seeds .paperclip/design/*.md into a managed project workspace directory
